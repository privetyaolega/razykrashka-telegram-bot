package com.razykrashka.bot.service.stage.utils;
...
public class SendMessageUtils {
    ...
    private String createSingleMeetingMainInformationText(Meeting meeting) {
        return meeting.getMeetingDateTime().format(DateTimeFormatter.ofPattern("dd MMMM (EEEE) HH:mm",
                Locale.ENGLISH)) + "\n"
