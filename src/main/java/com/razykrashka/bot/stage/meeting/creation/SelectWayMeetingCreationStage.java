...
import com.razykrashka.bot.stage.meeting.creation.sbs.CreateMeetingSBSStage;
...
public class SelectWayMeetingCreationStage extends MainStage {
    ...
    public ReplyKeyboard getKeyboard() {
        return keyboardBuilder.getKeyboard()
                ...
                .setRow(StageInfo.CREATE_MEETING_ON_STEPS.getKeyword(), CreateMeetingSBSStage.class.getSimpleName())
                .build();
    }
